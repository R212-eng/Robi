...
public class manageCompressedFile {
    ...
    public static List<String> stringToByte(String str){
        List<String> byteStrings = new ArrayList<String>();
        
        for(int i= str.length(); i > -1 ; i=i-8){
            if((i-8)>-1){
                byteStrings.add(0,str.substring(i-8,i).trim());
            }
            else{
                byteStrings.add(0,str.substring(0,i).trim());
            }            
        }
        return byteStrings;
    }
   ...
   public String binaryArrayToString(List<String> byteStrings){
    ...
    private String[] fixBitLength(String[] codes, int[] codesArrayLength) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private String fixBinaryStringLength(String string, int len) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
